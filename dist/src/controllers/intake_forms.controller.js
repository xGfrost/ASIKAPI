...
export async function getConsultationIntakeForm(req, res) {
    if (!req.params.id)
        return res
            .status(400)
            .json({ error: { message: "Psychologist ID is required" } });
...
export async function updateIntakeForm(req, res) {
    if (!req.params.id)
        return res
            .status(400)
            .json({ error: { message: "Psychologist ID is required" } });
...
export async function listPsychologistIntakeForms(req, res) {
    if (!req.params.id)
        return res
            .status(400)
            .json({ error: { message: "Psychologist ID is required" } });
