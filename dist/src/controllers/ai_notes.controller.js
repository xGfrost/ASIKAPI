...
export async function saveAiConsultationNotes(req, res) {
    if (!req.params.id)
        return res
            .status(400)
...
export async function getAiConsultationNotes(req, res) {
    if (!req.params.id)
        return res
            .status(400)
            .json({ error: { message: "Psychologist ID is required" } });
...
export async function updateAiConsultationNotes(req, res) {
    if (!req.params.id)
        return res
            .status(400)
            .json({ error: { message: "Psychologist ID is required" } });
